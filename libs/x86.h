...
{
    switch (regnum) {
        case 0: __asm__ volatile ("movl %0, %%db0" :: "r" (value)); break;
        case 1: __asm__ volatile ("movl %0, %%db1" :: "r" (value)); break;
        case 2: __asm__ volatile ("movl %0, %%db2" :: "r" (value)); break;
        case 3: __asm__ volatile ("movl %0, %%db3" :: "r" (value)); break;
        case 6: __asm__ volatile ("movl %0, %%db6" :: "r" (value)); break;
        case 7: __asm__ volatile ("movl %0, %%db7" :: "r" (value)); break;
    }
}
