/*************************************************************************
	> File Name: skew_heap.h
	> Author: TTc
	> Mail: liutianshxkernel@gmail.com
	> Created Time: Sun 14 Aug 2016 02:33:55 AM PDT
 ************************************************************************/
#ifndef __LIBS_SKEW_HEAP_H
#define __LIBS_SKEW_HEAP_H

/* 基本的优先队列数据结构*/
struct skew_heap_entry
{
    struct skew_heap_entry *parent;
    struct skew_heap_entry *left;
    struct skew_heap_entry *right;
};
